...
def related(self, label: str | list[str], ref_name: str = None, properties: dict = {}, min_hops: int = 1, max_hops: int = 1, **kwargs):
    return RelationAvailable(self.query + self._directed_relation('none', label, ref_name, properties, min_hops, max_hops, **kwargs))


def related_to(self, label: str | list[str], ref_name: str = None, properties: str = {}, min_hops: int = 1, max_hops: int = 1, **kwargs):
    return RelationAvailable(self.query + self._directed_relation('forward', label, ref_name, properties, min_hops, max_hops, **kwargs))


def related_from(self, label: str | list[str], ref_name: str = None, properties: str = {}, min_hops: int = 1, max_hops: int = 1, **kwargs):
    return RelationAvailable(self.query + self._directed_relation('backward', label, ref_name, properties, min_hops, max_hops, **kwargs))


def _directed_relation(self, direction: str, label: str | list[str], ref_name: str = None, properties: str = {}, min_hops: int = 1, max_hops: int = 1, **kwargs):
