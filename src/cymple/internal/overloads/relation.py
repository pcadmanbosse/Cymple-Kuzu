...
def related(self, label: str | list[str], ref_name: str = None, properties: dict = {}, min_hops: int = 1, max_hops: int = 1, shortest: bool = False, **kwargs):
...
def related_to(self, label: str | list[str], ref_name: str = None, properties: str = {}, min_hops: int = 1, max_hops: int = 1, shortest: bool = False, **kwargs):
...
def related_from(self, label: str | list[str], ref_name: str = None, properties: str = {}, min_hops: int = 1, max_hops: int = 1, shortest: bool = False, **kwargs):
...
def _directed_relation(self, direction: str, label: str | list[str], ref_name: str = None, properties: str = {}, min_hops: int = 1, max_hops: int = 1, shortest: bool = False, **kwargs):
