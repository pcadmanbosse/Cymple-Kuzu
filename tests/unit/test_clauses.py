...
rendered = {
    ...
    'RELATION (multiple edge types)': qb.reset().match().node().related(label=['Relation','OtherRelation'], ref_name='rel').node(),
...
expected = {
    ...
    'RELATION (multiple edge types)': 'MATCH ()-[rel:Relation|:OtherRelation]-()',
