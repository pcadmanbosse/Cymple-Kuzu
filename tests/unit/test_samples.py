...
rendered = {
    ...
    basic.get_all_nodes_related_to_nodes.__name__:
        basic.get_all_nodes_related_to_nodes(
            src_node_labels='Movie', dst_node_labels='Director', relationship_type='has_directed', dst_node_name='director'),
    basic.get_all_nodes_related_by_fixed_num_of_hops.__name__:
        basic.get_all_nodes_related_by_fixed_num_of_hops(
            src_node_labels='Movie', dst_node_labels='Director', num_hops=2, dst_node_name='director'),
    basic.get_all_nodes_related_by_varying_num_of_hops.__name__:
        basic.get_all_nodes_related_by_varying_num_of_hops(
            src_node_labels='Movie', dst_node_labels='Director', min_hops=1, max_hops=3, dst_node_name='director'),
    # Write Operations #
